...
- `kotlinter` is the formatter/linter (ktlint-gradle has an open bug excluding Chasm's generated sources; see `exp-mbt-chasm-kmp/docs/todo.md` for the switch rationale).
